...
def parse_arguments():
    ...
    parser.add_argument("--data_path", default=os.environ.get("MINTREC_DATA_PATH", "datasets"), type=str,
    ...
    parser.add_argument("--bert_path", default=os.environ.get("BERT_PATH", ""), type=str,
                        help="Optional path prefix for a local BERT checkpoint.")
